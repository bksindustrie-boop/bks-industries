...
const DEFAULT_PRODUCTS_DATA = [
  ...
  },
  {
    ...
    specs: ['Dual Stainless Steel Oil Tanks (12L + 12L)', 'Thermostatic Temperature Control (50-200Â°C)', 'High-Grade SS Mesh Frying Baskets', 'Bottom Oil Drain Valve Tap'],
  ...
  // =========================================================================
  {
    ...
    fuel: 'Electric 220V',
    specs: ['Capacity: 500L - 600L Storage Volume', 'Temp: +2Â°C to +8Â°C (Chiller) / -18Â°C (Freezer)', 'Heavy Tropicalized Compressor (up to 43Â°C ambient)', 'Digital Microprocessor Temperature Controller'],
  ...
  // =========================================================================
  {
    ...
    fuel: 'Electric 220V / LPG Gas',
    specs: ['Holds 3 / 4 / 6 Standard GN Food Containers', 'Thermostatic Temperature Control (30-110Â°C)', 'Toughened Curved Glass Sneeze Guard Cover', 'Ball Valve Bottom Water Drainage System'],
  ...
  },
  {
    ...
    fuel: 'Electric 220V',
    specs: ['Front Heated Curved Anti-Fog Double Glazed Glass', 'Temperature: +2Â°C to +8Â°C with Humidity Retention', '3-Tier Adjustable Glass Shelves with Warm LED Lights', 'Mirror Polished SS 304 Base'],
  ...
  },
  {
    ...
    fuel: 'Electric 220V',
    specs: ['Heavy Cast Iron Ribbed Pressing Plates', 'Thermostat Control (50-300Â°C) with Indicator', 'Counterbalanced Floating Top Press Lid', 'Removable Bottom Grease Drip Tray'],
  ...
  },
  {
    ...
    fuel: 'None',
    specs: ['Multi-Tier Heavy Gauge Perforated SS Baskets', '360Â° Air Circulation to Prevent Vegetable Spoilage', 'Heavy Duty 4" PU Castor Wheels', 'Capacity: 100kg+ Bulk Root Vegetables'],
  ...
  try {
    ...
    if (saved) {
      ...
      if (Array.isArray(parsed) && parsed.length > 0) {
        const customProds = parsed.filter(p => p && p.isCustom);
